...
Route::middleware(['Admin'])->group(function () {
    ...
    Route::get('/organization-data', [DashboardController::class, 'getOrganizationData']);
    ...
    Route::put('/update-tingkat', [KelasController::class, 'updateTingkat'])->name('updateTingkat');
    ...
    Route::get('/printCard', [ProfileController::class, 'printPDF']);
